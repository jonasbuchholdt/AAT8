...
In this section, the first order gradient speaker simulation result will be presented and compared to the analytical model.
...
\end{subfigure} 
\caption{The figure compares the analytical model and the \gls{fdtd} model of the speaker array at \SI{70}{\hertz}}
\end{figure}
...
\end{subfigure} 
\caption{The figure compares the analytical model and the \gls{fdtd} model of the speaker array at \SI{80}{\hertz}}
\end{figure}
...
\end{subfigure} 
\caption{The figure compares the analytical model and the \gls{fdtd} model of the speaker array model at \SI{90}{\hertz}}
\end{figure}
