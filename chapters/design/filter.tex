...
\section{Result} 
It might be interesting to look at the resulting magnitude response of the beamforming array with filtered data. The \autoref{} shows the magnitude plot of the analytical model where the filter parameters is  added.
