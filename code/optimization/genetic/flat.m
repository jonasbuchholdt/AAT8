...
load('cor_table_01.mat')              % path for correction table
...
Nstart=20;                             % number of generations for highest frequency
...
for k=1:Nstart
    tic;
    fit=fitness_pcor(population,n,ftop,polylf,polyhf,phi_mat,f_mat,p_mat,speakerangle);
...
save('flat_02.mat','solutions','ftop','fres','fbot','speakerangle','polyhf','polylf')